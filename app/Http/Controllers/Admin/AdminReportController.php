...
class AdminReportController extends Controller
{
    ...
    public function programs(Request $request)
    {
        ...
        if ($request->filled('category')) {
            $query->where('main_category', $request->input('category'));
        }
        ...
        $categories = Program::distinct('main_category')->pluck('main_category');
    ...
    {
        return Program::select('main_category', DB::raw('COUNT(*) as count'))
