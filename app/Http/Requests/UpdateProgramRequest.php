...
class UpdateProgramRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'program_start_date' => 'nullable|date|after_or_equal:application_deadline',
    ...
    public function messages(): array
    {
        return [
            ...
            'program_start_date.after_or_equal' => 'La fecha de inicio debe ser posterior o igual a la fecha límite.',
