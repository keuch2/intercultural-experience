...
@section('title', 'Programa IE: ' . $program->name)
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">
                                <span class="badge bg-info me-2">IE</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            @if($program->image)
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Imagen del Programa</h5>
                                    </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="text-center mb-3">
                                        <h3 class="text-primary">{{ $program->applications->count() }}</h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="progress" style="height: 4px;">
                                                    <div class="progress-bar" role="progressbar" style="width: {{ $application->progress_percentage ?? 0 }}%"></div>
                                                </div>
