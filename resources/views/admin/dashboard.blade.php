...
{{-- Módulo 13: Differentiated user type metrics --}}
<!-- Dashboard Cards -->
<div class="row mb-4">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <small class="text-muted">
                            {{ $participantCount ?? 0 }} participantes &middot;
                            {{ $agentCount ?? 0 }} agentes &middot;
                            {{ $adminCount ?? 0 }} admins
                        </small>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                            Au Pair</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $auPairCount ?? 0 }}</div>
                        <small class="text-muted">
                            {{ $auPairAdmissionCount ?? 0 }} admisión &middot;
                            {{ $auPairActiveCount ?? 0 }} activos
                        </small>
                    </div>
                    <div class="col-auto">
