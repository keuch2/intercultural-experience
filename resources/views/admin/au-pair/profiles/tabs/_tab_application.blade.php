    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.aupair.profiles.upload-doc', $user->id) }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3"><label class="form-label small">Archivo <span class="text-danger">*</span></label><input type="file" name="file" class="form-control form-control-sm" required accept=".pdf,.jpg,.jpeg,.png,.doc,.docx,.mp4,.mov"><small class="text-muted">Máx. 20MB</small></div>
