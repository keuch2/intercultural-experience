            ...
            <div class="card-body py-3">
                ...
                <div class="border-bottom pb-2 mb-2">
                    <div class="small text-muted mb-1" style="font-size: 0.7rem;">
                        ...
                        <form method="POST" action="{{ route('admin.aupair.profiles.delete-note', ['id' => $user->id, 'noteId' => $note->id]) }}" class="d-inline ms-1" onsubmit="return confirm('¿Eliminar nota?')">
                            @csrf @method('DELETE')
                ...
                {{-- New note form --}}
                <form method="POST" action="{{ route('admin.aupair.profiles.store-note', $user->id) }}">
                    @csrf
