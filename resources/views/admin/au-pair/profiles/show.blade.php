        ...
        <div class="card shadow-sm mt-3">
            <div class="card-body py-3">
                ...
                <div class="small">
                    ...
                    {{-- Fase 4 F4.5: "Progreso de pagos" reemplaza "Pago 1/Pago 2" --}}
                    <div class="mb-2">
                        <div class="d-flex justify-content-between mb-1">
                            <span class="text-muted">Progreso de pagos:</span>
                        ...
                        <div class="progress" style="height: 5px;">
                            <div class="progress-bar {{ $paymentPercentage >= 100 ? 'bg-success' : ($paymentPercentage > 0 ? 'bg-warning' : 'bg-danger') }}" style="width: {{ $paymentPercentage }}%"></div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between mb-1">
