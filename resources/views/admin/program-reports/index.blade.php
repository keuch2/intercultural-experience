...
<div class="card shadow-sm mb-4"><div class="card-body py-3">
    <form method="GET" class="row g-2 align-items-end">
        ...
        <div class="col-md-2"><label class="form-label small text-muted mb-1">Oferta laboral</label><select name="offer_id" class="form-select form-select-sm"><option value="">Todas</option>@foreach($options['offers'] as $o)<option value="{{ $o->id }}" {{ (string) request('offer_id') === (string) $o->id ? 'selected' : '' }}>{{ $o->employer_name }} ({{ $o->city }})</option>@endforeach</select></div>
