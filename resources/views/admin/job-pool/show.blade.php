...
@section('title', $offer->employer_name . ' — Pool de Ofertas')
@section('content')
...
<div class="card shadow-sm mb-4"><div class="card-body">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
        <div>
            <h3 class="mb-1"><i class="fas fa-briefcase text-primary me-2"></i>{{ $offer->employer_name }} <span class="badge bg-{{ $offer->status_color }} ms-2">{{ $offer->status_label }}</span></h3>
