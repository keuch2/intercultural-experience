...
<div class="card shadow-sm mb-4"><div class="card-body py-3">
    <form method="GET" class="row g-2 align-items-end">
        <div class="col-md-4"><label class="form-label small text-muted mb-1">Buscar</label><input type="text" name="search" class="form-control form-control-sm" placeholder="Empleador, ciudad o estado" value="{{ request('search') }}"></div>
...
<div class="card shadow-sm"><div class="table-responsive">
    <table class="table table-hover align-middle mb-0">
        <thead class="table-light"><tr><th>Empleador</th><th>Ubicación</th><th class="text-center">Posiciones</th><th class="text-center">Asignados</th><th>Estado</th><th>PDF</th><th>Publicada</th><th></th></tr></thead>
        <tbody>
        @forelse($offers as $offer)
        <tr>
            <td><a href="{{ route('admin.program.job-pool.show', [$program->slug, $offer->id]) }}" class="fw-semibold text-decoration-none">{{ $offer->employer_name }}</a></td>
