        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ $offer ? route('admin.program.job-pool.update', [$program->slug, $offer->id]) : route('admin.program.job-pool.store', $program->slug) }}" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12"><label class="form-label">Empleador *</label><input type="text" name="employer_name" class="form-control @error('employer_name') is-invalid @enderror" value="{{ old('employer_name', $offer?->employer_name) }}" required></div>
