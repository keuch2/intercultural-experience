            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title">Programas YFU</h3>
                        <div class="btn-group">
                            <a href="{{ route('admin.yfu-programs.create') }}" class="btn btn-primary">
                                <i class="fas fa-plus"></i> Nuevo Programa YFU
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body border-bottom">
                    <form action="{{ route('admin.yfu-programs.index') }}" method="GET" class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            ...
                            <a href="{{ route('admin.yfu-programs.index') }}" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($programs as $program)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-warning">{{ $program->subcategory ?: 'Sin categoría' }}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('admin.yfu-programs.show', $program) }}" 
                                                    ...
                                                    <a href="{{ route('admin.yfu-programs.edit', $program) }}" 
                                                       class="btn btn-sm btn-outline-primary" title="Editar">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('admin.yfu-programs.destroy', $program) }}" 
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <h5 class="text-muted">No hay programas YFU registrados</h5>
                            <p class="text-muted">Comienza creando tu primer programa YFU.</p>
                            <a href="{{ route('admin.yfu-programs.create') }}" class="btn btn-primary">
                                <i class="fas fa-plus"></i> Crear Programa YFU
                            </a>
                        </div>
                    @endif
                </div>
