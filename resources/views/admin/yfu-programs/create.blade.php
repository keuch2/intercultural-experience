...
@section('title', 'Crear Programa YFU')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title">Crear Nuevo Programa YFU</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.yfu-programs.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Guardar Programa YFU
                            </button>
                        </div>
                    </form>
                </div>
