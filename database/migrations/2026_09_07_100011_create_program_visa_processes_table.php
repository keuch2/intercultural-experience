...
/**
 * Proceso de visa J1 genérico (clon de au_pair_visa_processes, secciones C1–C6).
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('program_visa_processes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('program_visa_processes');
    }
};
